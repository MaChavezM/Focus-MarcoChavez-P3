 ...
 * Extiende de RecyclerView.Adapter parametrizado con nuestro ViewHolder
 * específico
 * 
...
public class SessionHistoryAdapter extends RecyclerView.Adapter<SessionHistoryAdapter.SessionViewHolder> {
    ...
    /**
     * Clase interna que describe y mantiene las referencias a los widgets de cada
     * ítem.
    ...
    /**
     * Metodo encargado de "inflar" (crear) el layout XML para cada entrada de la
     * lista.
    ...
    /**
     * Metodo encargado de vincular los datos del objeto Session con los widgets del
     * ViewHolder.
