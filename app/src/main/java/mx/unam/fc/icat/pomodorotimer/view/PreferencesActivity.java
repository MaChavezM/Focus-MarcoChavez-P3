 ...
 * Implementa un Listener para reaccionar a cambios en los ajustes (como el
 * idioma).
 * TODO: Asegurarse de agregar la dependencia de AndroidX Preference en el
 * build.gradle.
 * 
...
public class PreferencesActivity extends AppCompatActivity
    ...
    protected void onResume() {
        super.onResume();
        // Registramos el listener para detectar cambios mientras la actividad es
        // visible
