...
public class SessionHistoryActivity extends AppCompatActivity {
    ...
    private void bindViews() {
        ...
        /*
         * sessionManager.addSession(new Session("Enfoque", "18 mar 2026", "15:00", 25,
         * true));
         * sessionManager.addSession(new Session("Descanso", "18 mar 2026", "15:25", 5,
         * true));
         * sessionManager.addSession(new Session("Enfoque", "18 mar 2026", "17:25", 3,
         * false));
         * sessionManager.addSession(new Session("Descanso", "18 mar 2026", "18:30", 15,
         * true));
         */
    }
    ...
    private void updateHistoryDisplay() {
        ...
        // TODO: Investigar cómo usar Plurals en strings.xml para manejar "1 sesión" vs
        // "2 sesiones".
